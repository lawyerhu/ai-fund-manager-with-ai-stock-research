...
def _comparison_prompt(context: dict, candidate_rescore: dict, packet: dict, pair_audit: dict) -> str:
    ...
    return (
        ...
        "fixed style or quality prior. Compare Incumbent Remaining Alpha directly with Challenger Remaining Alpha: "
        "assuming neither security is held today and the same capital is invested from current prices, which has the "
        "more credible and larger remaining expectation gap after reasonable research-layer friction? "
